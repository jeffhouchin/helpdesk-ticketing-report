  ...
  generateSupervisorHTML(supervisorReport) {
    ...
    <head>
        <style>
            ...
            .ai-tag { background: #28a745; color: white; padding: 2px 6px; border-radius: 12px; font-size: 11px; margin-left: 10px; }
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>Generated by Intelligent Supervisor System • Next update: ${new Date(Date.now() + 24*60*60*1000).toLocaleDateString()} at 6:30 AM</p>
  ...
  generateActionableDashboardHTML(supervisorReport) {
    ...
    <head>
        <style>
            ...
            .footer { padding: 20px; text-align: center; background: #f8f9fa; color: #666; font-size: 12px; }
            .smart-badge { background: #007bff; color: white; padding: 2px 8px; border-radius: 12px; font-size: 11px; margin-left: 10px; }
        </style>
    </head>
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>${new Date().toLocaleDateString('en-US', {timeZone: 'America/New_York'})} • ${new Date().toLocaleTimeString('en-US', {timeZone: 'America/New_York'})} EST • Smart Analytics <span class="smart-badge">Enhanced</span></p>
            </div>
